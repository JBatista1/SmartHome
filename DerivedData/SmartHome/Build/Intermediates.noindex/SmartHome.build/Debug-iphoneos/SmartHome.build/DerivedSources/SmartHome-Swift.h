...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmartHome",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SmartHome11AppDelegate")
...
SWIFT_CLASS("_TtC9SmartHome18HomeViewController")
@interface HomeViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified devicesCollection;
- (void)viewDidLoad;
- (IBAction)newDevice:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9SmartHome13SceneDelegate")
...
SWIFT_CLASS("_TtC9SmartHome20SearchViewController")
@interface SearchViewController : BaseViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified devicesTable;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified searchButton;
- (void)viewDidLoad;
- (IBAction)searchDevices:(id _Nonnull)sender;
- (void)stopScan;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SearchViewController (SWIFT_EXTENSION(SmartHome)) <UITableViewDataSource, UITableViewDelegate>
